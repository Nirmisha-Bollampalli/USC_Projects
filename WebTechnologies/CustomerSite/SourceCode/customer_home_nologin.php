...
<body background="Temp.png">
                ...
                <div style="position:absolute;left:10.5in;top:0in;height:0in;width:10in;display:block;">
					<TABLE border="0">
						<TR>
						<TD width="60px" ><a href="customer_home_nologin.php"><p style="color:white"><u>Home</u></p></a></TD>
						<TD width="60px" ><a href="signup.php"><p style="color:white"><u>Sign In</u></p></a></TD>
						<TD><a href="register.php"><p style="color:white"><u>Register</u></p></a></TD></TR>
					</TABLE>
				</div> 
       <!-- Top Menu-->     
