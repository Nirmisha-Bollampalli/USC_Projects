...
<form name="del_user" method = "Post" action="Delete_User.php">
<div id="div1" style="position:absolute;left:4.3in;top:3.5in;height:0in;width:10in;display:block;">

<fieldset style="width:450px ;height:100px">
<legend style="color:blue">User Rights</legend>
<table >
<tr><td><p style="color:blue"> User Credential :</p><td><td>Admin</td></tr>

<tr><td><p style="color:blue"> User Rights :</p><td><td>Add or Delete or Modify Other User Information </td></tr>

<tr><td><p style="color:blue"> Contact Us :</p><td><td>For any Help Contact Us At "232-326-9932"</td></tr>
