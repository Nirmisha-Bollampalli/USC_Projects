...
if ( $frame == "product" || $frame == "specialsales" || $frame== "reports")
{
...
if ( $frame == "product" || $frame == "products")
{
		$postback_str = $postback_str .'<table border="0" cellspacing="2" cellpadding="0"  width="70%">';
...
{
		$postback_str = $postback_str .'<table border="0" cellspacing="2" cellpadding="0"  width="80%">';
		$postback_str = $postback_str . '<tr> <td Class="tabdivheadercolor"> Product Name</td><td> <input type="text" id ="pname" name="pname" /> </td> <td colspan="2" Class="tabdivheadercolor"> Date from &nbsp; <input type="text" id ="from" name="from" /> &nbsp; to <input type="text" id ="to" name="to" /> </td> 		</tr>';
		$postback_str = $postback_str . '<tr> <td Class="tabdivheadercolor"> Product Category</td> <td colspan="3" >'.$drop_down.'</td></tr>';
		$postback_str = $postback_str . "<tr> <td Class='tabdivheadercolor'>Special Sales</td><td> <input type='CheckBox' id='special' name='specialcheck' /> </td> </tr>";
		$postback_str = $postback_str . '<tr height="15px"> <td> </td> </tr>';
		$postback_str = $postback_str . '<tr> <td colspan="4"> <div align="left"> <input type="button" style="color:blue;width:80px;height:25px" name="reportsearch" value="Search" onclick="getreportresults()" ></div></td></tr>';
		$postback_str = $postback_str . '</table>';
}
if ( $frame == "vieworders")
{
		$postback_str = $postback_str .'<table border="0" cellspacing="2" cellpadding="0"  width="60%">';
		$postback_str = $postback_str . '<tr> <td colspan="2" Class="tabdivheadercolor"> Search by Date from &nbsp; <input type="text" id ="from" name="from" /> &nbsp; to <input type="text" id ="to" name="to" /> </td> 		</tr>';
		$postback_str = $postback_str . '<tr height="15px"> <td> </td> </tr>';
		$postback_str = $postback_str . '<tr> <td colspan="4"> <div align="left"> <input type="button" style="color:blue;width:80px;height:25px" name="vieworderssearch" value="Search" onclick="getviewordersresults()" ></div></td></tr>';
		$postback_str = $postback_str . '</table>';
}
