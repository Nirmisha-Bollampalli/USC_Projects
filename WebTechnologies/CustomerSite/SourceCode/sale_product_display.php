...
$sql = mysql_query("SELECT c.ProductName FROM  cakes c INNER JOIN special_sales s on c.ProductID = s.ProductID where s.EndDate >= '$currentdate'");
...
$sql2 = mysql_query("SELECT c.ProductID,c.ProductName,c.ProductImage,c.ProductPrice,s.Discount FROM  cakes c INNER JOIN special_sales s on s.ProductID = c.ProductID  where s.EndDate >= '$currentdate' $limit"); 
