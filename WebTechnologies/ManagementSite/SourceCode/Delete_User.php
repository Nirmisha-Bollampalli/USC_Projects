...
<p Style="color:blue"><b></b>Please Enter A UserName To Proceed(Mandatory)<b></b></p>
...
<tr><td style="color:blue"><input type="Submit" name="continue" value="Delete" style="color:blue"></td></tr>
</table>
</fieldset>
</div>
</form>
...
<?php
	   ...
	   $username="root";
		...
		$check = "select * from user_table where UserName='$_POST[Uname]'";
		 $result = mysql_query($check);
		 $num = mysql_num_rows($result);
	   if($num)
       {	   
	   $query_delete = "DELETE FROM user_table WHERE UserName='$_POST[Uname]'";
