...
$sql = mysql_query("SELECT c.ProductID,c.ProductName,c.ProductImage,c.ProductPrice,s.Discount FROM  cakes c INNER JOIN special_sales s on s.ProductID = c.ProductID and s.EndDate >= '$currentdate' where CategoryID ='$_GET[ID]' ");
...
<body background="Temp.png">
       ...
       <!-- Top Menu-->  
			   ...
			   <?PHP 
			   if($outputList == '')
				  echo '<td width="680px" ></td>';
			 
			  
               ?>
			    <td> <?PHP echo $outputList ?> </td>;
				</tr>
				</Table>
