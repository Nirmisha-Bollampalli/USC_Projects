...
{
   // alert("Edit_Special_Sales.php?ID="+a+"&Type="+b);
    document.body.action ="Edit_Special_Sales.php?ID="+a+"&Type="+b;
...
$query="SELECT * FROM special_sales ";
...
<div id="div1" style="position:absolute;left:3.6in;top:3in;height:0in;width:10in;display:block;">
...
<td  Class="tabdivheadercolor">Product ID</td>

<td  Class="tabdivheadercolor">Discount</td>

<td  Class="tabdivheadercolor">Sale Start Date</td>

<td  Class="tabdivheadercolor">Sale End Date</td>

<td  Class="tabdivheadercolor">Product Image</td>

<td  Class="tabdivheadercolor">Edit</td>

<td  Class="tabdivheadercolor">Delete</td>
...
$f2=mysql_result($result,$i,"SpecialSalesID");

$f3=mysql_result($result,$i,"Discount");

$f4=mysql_result($result,$i,"StartDate");

$f5=mysql_result($result,$i,"EndDate");

$f6=mysql_result($result,$i,"ProductImage");
